	...
	private function get_about_localization_data() {
		...
		return [
			...
			'strings'            => [
				...
				'heroTextSecond'   => __( 'At Themeisle, we offer a wide range of WordPress themes and plugins that are designed to meet the needs of both beginners and advanced users. Our products are feature-rich, easy to use, and are designed to help you create beautiful and functional websites.', 'hestia' ),
				'teamImageCaption' => __( 'Our team in WCEU2022 in Portugal', 'hestia' ),
				'newsHeading'      => __( 'Stay connected for news & updates!', 'hestia' ),
				'emailPlaceholder' => __( 'Your email address', 'hestia' ),
				'signMeUp'         => __( 'Sign me up', 'hestia' ),
				'installNow'       => __( 'Install Now', 'hestia' ),
				'activate'         => __( 'Activate', 'hestia' ),
				'learnMore'        => __( 'Learn More', 'hestia' ),
				'installed'        => __( 'Installed', 'hestia' ),
	...
	private function get_product_pages_data( $product_pages ) {
		...
		$pages = [
			'otter-page' => [
				...
				'plugin'  => $otter_plugin,
				'strings' => [
					'heading'      => __( 'Build innovative layouts with Otter Blocks and Gutenberg', 'hestia' ),
					'text'         => __( 'Otter is a lightweight, dynamic collection of page building blocks and templates for the WordPress block editor.', 'hestia' ),
					'buttons'      => [
						'install_otter_free' => __( "Install Otter - It's free!", 'hestia' ),
						'install_now'        => __( 'Install Now', 'hestia' ),
						'learn_more'         => __( 'Learn More', 'hestia' ),
						'learn_more_link'    => tsdk_utmify( 'https://themeisle.com/plugins/otter-blocks/', 'otter-page', 'about-us' ),
					],
					'features'     => [
						'advancedTitle' => __( 'Advanced Features', 'hestia' ),
						'advancedDesc'  => __( 'Add features such as Custom CSS, Animations & Visibility Conditions to all blocks.', 'hestia' ),
						'fastTitle'     => __( 'Lightweight and Fast', 'hestia' ),
						'fastDesc'      => __( 'Otter enhances WordPress site building experience without impacting site speed.', 'hestia' ),
						'mobileTitle'   => __( 'Mobile-Friendly', 'hestia' ),
						'mobileDesc'    => __( 'Each block can be tweaked to provide a consistent experience across all devices.', 'hestia' ),
					],
					'details'      => [
						's1Image' => $this->get_sdk_uri() . 'assets/images/otter/otter-builder.png',
						's1Title' => __( 'A Better Page Building Experience', 'hestia' ),
						's1Text'  => __( 'Otter can be used to build everything from a personal blog to an e-commerce site without losing the personal touch. Otter’s ease of use transforms basic blocks into expressive layouts in seconds.', 'hestia' ),
						's2Image' => $this->get_sdk_uri() . 'assets/images/otter/otter-patterns.png',
						's2Title' => __( 'A New Collection of Patterns', 'hestia' ),
						's2Text'  => __( 'A New Patterns Library, containing a range of different elements in a variety of styles to help you build great pages. All of your website’s most important areas are covered: headers, testimonials, pricing tables, sections and more.', 'hestia' ),
						's3Image' => $this->get_sdk_uri() . 'assets/images/otter/otter-library.png',
						's3Title' => __( 'Advanced Blocks', 'hestia' ),
						's3Text'  => __( 'Enhance your website’s design with powerful blocks, like the Add to Cart, Business Hours, Review Comparison, and dozens of WooCommerce blocks.', 'hestia' ),
					],
					'testimonials' => [
						'heading' => __( 'Trusted by more than 300K website owners', 'hestia' ),
						'users'   => [
							[
	...
	private function get_other_products_data() {
		$products = [
			...
			'neve'                                => [
				'skip_api'    => true,
				'name'        => 'Neve',
				'description' => __( 'A fast, lightweight, customizable WordPress theme offering responsive design, speed, and flexibility for various website types.', 'hestia' ),
			...
			'wp-landing-kit'                      => [
				...
				'name'        => 'WP Landing Kit',
				'description' => __( 'Turn WordPress into a landing page powerhouse with Landing Kit, map domains to pages or any other published resource.', 'hestia' ),
			...
			'sparks-for-woocommerce'              => [
				...
				'name'        => 'Sparks',
				'description' => __( 'Extend your store functionality with 8 ultra-performant features like product comparisons, variation swatches, wishlist, and more.', 'hestia' ),
